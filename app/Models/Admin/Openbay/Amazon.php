...
namespace Carrito\Models\Admin\Openbay;
...
class Amazon extends Model
{
  ...
  <MarketplaceIDs>';
    ...
    public function saveProduct($product_id, $data_array)
    {
        ...
        } elseif (isset($data_array['fields']['price'])) {
            $price = $data_array['fields']['price'];
        } elseif (isset($data_array['fields']['StandardPrice'])) {
        ...
        } elseif (isset($data_array['fields']['SKU'])) {
            $sku = $data_array['fields']['SKU'];
        }
