...
namespace Carrito\Models\Store\Affiliate;
...
class Affiliate extends Model
{
    ...
    public function editPassword($email, $password)
    {
        ...
        $this->db->query('UPDATE '.DB_PREFIX."affiliate SET salt = '".$this->db->escape($salt = random_str(9))."', password = '".$this->db->escape(sha1($salt.sha1($salt.sha1($password))))."' WHERE LOWER(email) = '".$this->db->escape(utf8_strtolower($email))."'");
