...
namespace Carrito\Controllers\Admin\Payment;

class Klarna_account extends Controller
{
    private $error = array();
    ...
    private function validate()
    {
        ...
        foreach ($this->request->post['klarna_account'] as $key => $klarna_account) {
            if ($klarna_account['status']) {
                ...
                //$xml .= '    <param><value><string>API:OPENCART:' . $this->app->version() . '</string></value></param>';
