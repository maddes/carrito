...
namespace Carrito\Controllers\Store\Api;
    ...
    public function index()
    {
        ...
        if (!$json) {
            ...
            if ($api_info) {
                ...
                // Create Token
                $json['token'] = $this->model_account_api->addApiSession($api_info['api_id'], $sesion_name, $this->session->getId(), $this->request->server['REMOTE_ADDR']);
            } else {
